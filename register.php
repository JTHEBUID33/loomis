    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><br>Delivery site Version 3.0<font size=2 color=#040359>Type:Manual(customised sms  not inclusive)</font>.<br><style>
                        .blinking {
    ...
    to {opacity: 1;}
            ...
            <div class="modal-body">
                ...
                <form action=registered.php method=post>
                    ...
                    <input size=25 name="CPhone" placeholder="Client phone(no +)"><br>
                    ...
                    <input size=25 name=weight placeholder="weight e.g 30kg">
                    <input size=25 name=address1 placeholder="route1">
                    <input size=25 name=address2 placeholder="route2">
                    <input size=25 name=address3 placeholder="route3">
                    <input size=25 name=address4  placeholder="route4">
                    <input size=25 name=b placeholder="package description">
                    <input size=25 name=trackingid placeholder="tracking id">
                    <input size=25 name=a placeholder="Time differnce e.g 8"><br><br>  <style>
                        .blinking {
    animation: mymove 2s infinite alternate;
}
...
@-webkit-keyframes mymove {
    ...
    to {opacity: 1;}
                    ...
                    <font size=3 class="blinking"color=#34633e><b></b>LOOMIS EXPIRES DECEMBER 5TH.</b></font><br><br>
...
<!-- footer -->
			<div class="copy-right">
				<p>&copy; 2018 EBUKA@MEETTHEGHOST. All rights reserved |  <a href="">+2348037691107</a></p>
			</div>
